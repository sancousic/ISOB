...
namespace ISOB_Client
{
    ...
    { 
        public static BitArray LeftShift(this BitArray bitArray, int count)
        {
            BitArray res = new BitArray(bitArray.Length);

            for(int i = count; i < res.Length; i++)
            {
                res[i] = bitArray[i - count];
            }

            return res;
        }
        public static BitArray RightShift(this BitArray bitArray, int count)
        {
            BitArray res = new BitArray(bitArray.Length);
